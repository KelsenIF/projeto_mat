...
$sql = "SELECT * FROM questoes WHERE id_situacao = 1 ORDER BY id DESC";
                    ...
                    <tbody>
                        <?php foreach ($questoes as $questao): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../../formularios/questao/editar_questao.php?id=<?php echo $questao['id']; ?>" class="btn btn-warning btn-sm">Editar</a>
                                    <a href="../../formularios/questao/excluir_questao.php?id=<?php echo $questao['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir esta questao?');">Excluir</a>
                                    <a href="../../formularios/questao/negar_questao.php?id=<?php echo $questao['id']; ?>" class="btn btn-secondary btn-sm">Negar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>

...
$sql = "SELECT questoes.*, assuntos.disciplina FROM questoes INNER JOIN assuntos ON questoes.id_assunto = assuntos.id WHERE questoes.id_situacao = 1 ORDER BY questoes.id DESC";

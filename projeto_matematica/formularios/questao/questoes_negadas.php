...
$sql = "SELECT questoes.*, assuntos.disciplina FROM questoes INNER JOIN assuntos ON questoes.id_assunto = assuntos.id WHERE questoes.id_situacao = 0 ORDER BY questoes.id DESC";

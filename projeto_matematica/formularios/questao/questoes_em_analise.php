...
$sql = "SELECT questoes.*, assuntos.disciplina FROM questoes INNER JOIN assuntos ON questoes.id_assunto = assuntos.id WHERE questoes.id_situacao = 2 ORDER BY questoes.id DESC";

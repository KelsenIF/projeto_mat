...
$stmt = $pdo->prepare($sql_escola); // Usei $stmt para clareza
$stmt->execute();
$escolas = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Verificação de segurança para o array principal
if (!isset($escolas)) {
    $escolas = []; // Garante que $escolas é um array mesmo se a query falhar
}
?>
...
<body>
    <form class="#" action="process_register.php" method="POST" enctype="multipart/form-data">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            escolaSelect.addEventListener('change', function () {
                ...
                fetch('get_classes.php?cod_inep=' + cod_inep)

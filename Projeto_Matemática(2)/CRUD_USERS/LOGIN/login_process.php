...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($info_user) {
        ...
        if (password_verify($log_senha, $senha_hash)) {
            ...
            $_SESSION['caminho_foto_de_perfil'] = $info_user['foto'];
            $_SESSION['nivel_de_acesso'] = $info_user['nivel_de_acesso'];

            if ($_SESSION['nivel_de_acesso'] == 0) {
            ...
            if ($_SESSION['nivel_de_acesso'] == 1) {
                ...
                $_SESSION['cargo'] = 'APOIADOR';
                header("Location: ../../Dashboards/Apoiadores/index.php");
                exit();
            }

            if ($_SESSION['nivel_de_acesso'] == 2) {

                $_SESSION['cargo'] = 'PROFESSOR';
                header("Location: ../../Dashboards/Professores/index.php");
                exit();
            }
            ...
            if ($_SESSION['nivel_de_acesso'] == 3) {
                ...
                header("Location: ../../Dashboards/Moderadores/index.php");
                exit();
            }

...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Cadastro turma</h1>

            <form class="row g-3 needs-validation" novalidate method="POST" action="proc_turma_criar.php">
    ...
    <input type="hidden" name="escola" class="form-control" id="escola" required <?php echo  "value='$escola_id'"?>>

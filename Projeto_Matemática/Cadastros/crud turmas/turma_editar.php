...
$turma = $turma[0];
$turma_ano = $turma['ano'];
$turma_id_escola = $turma['id_escola'];
$turma_id = $_GET['id'];
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Editar turma</h1>

            <form class="row g-3 needs-validation" novalidate method="POST" action="proc_turma_editar.php">

    <div class="col-md-4">
        <label for="ano" class="form-label">Ano</label>
        <input type="number" name="ano" min="1900" max="2099" step="1" class="form-control" id="ano" required <?php echo  "value='$turma_ano'"?>>

...
<body>
    <form class="form-neon" action="proc_disciplinas.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="disciplina" name="disciplina" required placeholder="Ex: Função Afim">
        </div>
        ...
        <div class="d-grid">
            <button type="submit" class="btn-neon">Salvar Disciplina</button>
        </div>
    </form>
</body>

...
$sql = "SELECT * FROM questões WHERE id_situacao = 0 ORDER BY id DESC";
                        ...
                        <?php foreach ($questoes as $questao): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="excluir_questao.php?id=<?php echo $questao['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir esta questão?');">Excluir</a>

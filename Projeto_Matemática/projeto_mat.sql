...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 18/09/2025 às 02:24
...
INSERT INTO `anos_escolaridades` (`id`, `nome_escolaridade`, `id_nível_ensino`) VALUES
...
--
-- Estrutura para tabela `níveis_ensino`
--

DROP TABLE IF EXISTS `níveis_ensino`;
CREATE TABLE IF NOT EXISTS `níveis_ensino` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nível_ensino` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Despejando dados para a tabela `níveis_ensino`
--

INSERT INTO `níveis_ensino` (`id`, `nível_ensino`) VALUES
...
--
-- Estrutura para tabela `questões`
--
...
CREATE TABLE IF NOT EXISTS `questões` (
  ...
  `foto_questão` varchar(256) NOT NULL,
